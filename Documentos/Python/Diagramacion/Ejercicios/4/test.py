...
def auto():
    ...
    if Puntos_a > Puntos_b and Puntos_a > Puntos_c:
        Punto_mas_contaminante = Puntos_a
    if Puntos_b > Puntos_a and Puntos_b > Puntos_c:
        Punto_mas_contaminante = Puntos_b
    if Puntos_c > Puntos_a and Puntos_c > Puntos_b:
        Punto_mas_contaminante = Puntos_c
    if Puntos_a < Puntos_b and Puntos_a < Puntos_c:
        Punto_menos_contaminante = Puntos_a
    if Puntos_b < Puntos_a and Puntos_b < Puntos_c:
        Punto_menos_contaminante = Puntos_b
    if Puntos_c < Puntos_a and Puntos_c < Puntos_b:
        Punto_menos_contaminante = 'Papa' + str(Puntos_c) 
